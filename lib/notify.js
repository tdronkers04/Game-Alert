...
async function getTodaysAlerts(start, end) {
  const GET_ALERTS = "SELECT s.tv_network, t.team_name_full, u.email_address, u.sms_phone_number, a.mode" +
                  ...
                  " UNION" +
                  " SELECT s.tv_network, t.team_name_full, u.email_address, u.sms_phone_number, a.mode" +
