...
function sendText(alertObject) {
  twilioClient.messages.create({
    body: `GAME ALERT! The ${alertObject.team_name_full} play at ${alertObject.game_date_utc.toLocaleString()} on ${alertObject.tv_network}`,
    from: '+14174532888',
...
function sendMail(alertObject) {
  ...
  const mailOptions = {
    ...
    html: getHTMLMessage(alertObject.team_name_full, alertObject.tv_network, alertObject.game_date_utc),
  }
